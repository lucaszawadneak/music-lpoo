            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#team">Pesquisar M�sica</a></li>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio1/${i}.0.jpg" alt="..." />
                            </a>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="ranking-item">
                                <a class="ranking-link" data-bs-toggle="modal" href="#rankingModal1">
                                    ...
                                    <img class="img-fluid" src="assets/img/portfolio/${i}.0.jpg" alt="..." />
                                </a>
